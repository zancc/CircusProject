...
//        System.out.println(RED + "This text is red!" + RESET);
    ...
    private static String printSymbol(int n) {
        if (Circus.numberOfPlayer == 1) {
            return (Circus.circusPlayers.get(0).getFieldPrint().get(n) + "      ");
        } else if (Circus.numberOfPlayer == 2) {
            return (Circus.circusPlayers.get(0).getFieldPrint().get(n) +
                    " " + Circus.circusPlayers.get(1).getFieldPrint().get(n) + "    ");
        } else if (Circus.numberOfPlayer == 3) {
            return (Circus.circusPlayers.get(0).getFieldPrint().get(n) +
                    " " + Circus.circusPlayers.get(1).getFieldPrint().get(n) +
                    " " + Circus.circusPlayers.get(2).getFieldPrint().get(n) + "  ");
        } else if (Circus.numberOfPlayer ==4) {
            return (Circus.circusPlayers.get(0).getFieldPrint().get(n) +
                    " " + Circus.circusPlayers.get(1).getFieldPrint().get(n) +
                    " " + Circus.circusPlayers.get(2).getFieldPrint().get(n) +
                    " " + Circus.circusPlayers.get(3).getFieldPrint().get(n));
        }
        return null;
    }
